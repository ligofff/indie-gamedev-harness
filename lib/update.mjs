...
import { findOpenCodeConfig, readOpenCodeConfig } from "./config.mjs";
...
export function updateHarness({ root, packageVersion, force = false, dryRun = false }) {
  ...
  return { dryRun, changed, conflicts, validation, updated: !conflicts.length };
}
