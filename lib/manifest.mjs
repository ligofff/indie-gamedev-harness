...
function validateManifest(manifest) {
  ...
  if (changes.variantsSetByInstaller !== undefined && !isPlainObject(changes.variantsSetByInstaller)) throw invalidManifest("Invalid config ownership: variantsSetByInstaller");
  for (const [role, value] of Object.entries(changes.variantsSetByInstaller || {})) {
    if (typeof role !== "string" || typeof value !== "string") throw invalidManifest("Invalid variant ownership");
  }
